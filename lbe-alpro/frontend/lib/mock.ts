...
const MOCK_EVENTS: Event[] = [
  ...
  },
  {
    id: 7,
    organizerId: 2,
    title: "ITS Fair: Bazar Kewirausahaan",
    category: "kewirausahaan",
    type: "bazar",
    description: "Pameran dan penjualan produk mahasiswa.",
    posterUrl: null,
    quota: 30,
  ...
  },
  {
    ...
    category: "keilmiahan",
    type: "riset",
    description: "Program riset bersama dosen energi terbarukan.",
    posterUrl: null,
    quota: 25,
  ...
  },
  {
    ...
    category: "kewirausahaan",
    type: "bootcamp",
    description: "Pelatihan intensif pemasaran digital untuk pemula.",
    posterUrl: null,
    quota: 60,
  ...
  },
  {
    ...
    category: "minat_bakat",
    type: "lomba",
    description: "Kompetisi desain poster tingkat ITS.",
    posterUrl: null,
    quota: 50,
    currentParticipants: 20,
    deadline: future(25),
  ...
  },
  {
    id: 11,
    organizerId: 2,
    title: "Funmatch Badminton Sore",
    category: "minat_bakat",
    type: "funmatch",
    description: "Sparing santai badminton antar departemen.",
    posterUrl: null,
    quota: 22,
  ...
  },
  {
    id: 12,
    organizerId: 2,
    title: "Oprec Staff Magang BEM (draft)",
    category: "manajerial",
    type: "oprec",
    description: "Belum tayang, menunggu moderasi.",
    posterUrl: null,
  ...
  },
  {
    ...
    category: "keilmiahan",
    type: "lomba",
    description: "Hackathon 36 jam solusi pintar untuk kampus.",
    posterUrl: null,
    quota: 100,
  ...
  },
  {
    ...
    category: "manajerial",
    type: "workshop",
    description: "Latihan berbicara di depan umum untuk pengurus organisasi.",
    posterUrl: null,
    quota: 35,
  ...
  },
  {
    ...
    category: "minat_bakat",
    type: "funmatch",
    description: "Sparing e-sport antar departemen.",
    posterUrl: null,
    quota: 32,
  ...
  },
  {
    id: 17,
    organizerId: 2,
    title: "Oprec Divisi Konsumsi (ditolak)",
    category: "manajerial",
    type: "oprec",
    description: "Ditolak admin, perlu revisi deskripsi.",
    posterUrl: null,
    quota: 15,
    currentParticipants: 0,
    deadline: future(20),
...
const MOCK_TEAMS: Team[] = [
  ...
  },
  {
    ...
    eventId: 8,
    creatorId: 1,
    title: "Tim Riset Paper AI",
    description: "Mencari 1 anggota untuk olah data dan penulisan paper.",
    contactInfo: "Hubungi @paper_ai",
    maxMembers: 3,
    createdAt: past(2),
  },
  {
    ...
    eventId: 11,
    creatorId: 3,
    title: "Squad Badminton Ganda",
    description: "Mencari pasangan ganda putra untuk funmatch sore.",
    contactInfo: "Hubungi @squad_bulutangkis",
    maxMembers: 4,
    createdAt: past(1),
  },
  {
    ...
    eventId: 13,
    creatorId: 3,
    title: "Tim Hackathon Backend",
    description: "Butuh backend Go dan satu UI/UX untuk hackathon.",
    contactInfo: "Hubungi @hack_backend",
    maxMembers: null,
    createdAt: past(1),
  },
];
...
const MOCK_TEAM_MEMBERS: TeamMember[] = [
  ...
  { id: 5, teamId: 5, userId: 1, joinedAt: past(2) },
  { id: 6, teamId: 6, userId: 3, joinedAt: past(1) },
  { id: 7, teamId: 6, userId: 1, joinedAt: past(1) },
  { id: 8, teamId: 7, userId: 3, joinedAt: past(1) },
];
